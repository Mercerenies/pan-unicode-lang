...
import { SymbolLit, tryCall } from './ast.js';

export async function spread(term: SymbolLit, state: Evaluator): Promise<void> {
...
export function cross(term: SymbolLit, state: Evaluator): Promise<void> {
...
export function apply(term: SymbolLit, state: Evaluator): Promise<void> {
...
export function cleave(term: SymbolLit, state: Evaluator): Promise<void> {
