...
export var binaryReduce = function(fn, term, state, opts: any = {}) {
...
export var binaryReduceRight = function(fn, term, state, opts: any = {}) {
  var adjustment, arr, mod, ref, ref1, top;
  adjustment = (ref = opts.modifierAdjustment) != null ? ref : function(x) {
    return x;
  };
...
export var mergeReduce = function(fn, reduce, term, state, opts: any = {}) {
...
export var noExtension = function(fn, term, state, opts: any = {}) {
  var a, b;
  [a, b] = state.pop(2);
  return state.push(fn(a, b));
};

export var binary = function(fn, term, state, opts: any = {}) {
  var one, zero;
  zero = opts.zero;
  one = opts.one;
...
export var binaryRight = function(fn, term, state, opts: any = {}) {
  var one, zero;
  zero = opts.zero;
  one = opts.one;
  if ((zero != null) && typeof zero !== 'function') {
...
export var merge = function(reduce) {
  return function(fn, term, state, opts: any = {}) {
    var one, zero;
...
export var op = function(state, term, opts: any = {}) {
