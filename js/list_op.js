...
var cartesianProductRec, getNodeLength, rebuild, runEach, runMap;
import * as Error from './error.js';
import { ArrayLit, NumberLit, StringLit, SentinelValue, tryCall, isTruthy, SimpleCmd } from './ast.js';
...
export var gradeUp = function (term, state) {
    ...
    indices = (function () {
        var results1 = [];
        for (var j = 0, ref = list.length - 1; 0 <= ref ? j <= ref : j >= ref; 0 <= ref ? j++ : j--) {
            results1.push(j);
        }
        return results1;
    })();
